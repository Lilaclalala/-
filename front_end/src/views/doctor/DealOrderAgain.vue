...
<div>
  <el-card>
    ...
    <el-row>
      ...
      <el-row>
        <el-col :span="12">
          <el-input v-model="queryDrug" placeholder="请输入药物名称查询" class="drugInput">
            <el-button
            slot="append"
            icon="el-icon-search"
            @click="requestDrug"
      ...
      <el-table :data="drugData" stripe border>
        ...
        <el-table-column label="操作" width="120" fixed="right">
          <template slot-scope="scope">
            <el-button type="success" size="small" style="font-size: 14px;" @click="addDrug(scope.row.drId)">
                  <i class="iconfont icon-add-button" style="font-size: 16px;"></i>增加</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!-- 分页 -->
...
<el-row></el-row>
      ...
      <!-- 右边已选择的药物 -->
      <el-col :span="12" class="drugRight">
        <el-table stripe border :data="drugBuyData" class="rightTable">
          <el-table-column label="编号" prop="drId"></el-table-column>
          <el-table-column label="名称" prop="drName"></el-table-column>
           <el-table-column label="单价" prop="drPrice"></el-table-column>
            <el-table-column label="数量" prop="drNum"></el-table-column>
             ...
             <el-table-column label="操作" width="120" fixed="right">
               <template slot-scope="scope">
                 <el-button type="danger" style="font-size: 14px;"size="small"
                  icon="iconfont icon-delete-button" @click="deleteDrug(scope.row.drId)"> 移除</el-button>
               </template>
             </el-table-column>
        </el-table>
...
<el-row>
      <el-col :span="12">
        <el-input v-model="queryCheck" placeholder="请输入检查项目名称查询" class="drugInput">
            <el-button
            slot="append"
            icon="el-icon-search"
            @click="requestCheck"
          ...
          <el-table stripe border :data="checkData">
            <el-table-column label="编号" prop="chId"></el-table-column>
             <el-table-column label="项目" prop="chName"></el-table-column>
              ...
              <el-table-column label="操作" width="120" fixed="right">
                <template slot-scope="scope">
                  <el-button size="small" type="success" style="font-size: 14px;" @click="addCheck(scope.row.chId)">
                  <i class="iconfont icon-add-button" style="font-size: 16px;"></i>
                  增加
                  </el-button>
                </template>
              </el-table-column>
      ...
      <!-- 右边已选择的检查 -->
      <el-col :span="12" class="drugRight">
        <el-table stripe border class="rightTable" :data="checkBuyData">
          <el-table-column label="编号" prop="chId"></el-table-column>
             <el-table-column label="项目" prop="chName"></el-table-column>
              <el-table-column label="价格" prop="chPrice"></el-table-column>
              <el-table-column label="操作" width="120" fixed="right">
                <template slot-scope="scope">
                  <el-button size="small" type="danger" style="font-size: 14px;"
                  icon="iconfont icon-delete-button" @click="deleteCheck(scope.row.chId)"> 移除</el-button>
                </template>
              </el-table-column>
              </el-table>
